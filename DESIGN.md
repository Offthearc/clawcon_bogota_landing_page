...
(96px) on desktop, collapsing to `xl` (40px) on mobile. A `--layout-max-width`
utility (1200 px) constrains inner content so lines stay readable on wide
screens. Sections span full viewport width with their own background colors for
horizontal rhythm.
